...
@Language("glsl")
val spherePlane = """
    Plane plane = Plane(vec3(0.0, 0.0, 0.0), normalize(vec3(0.0, 1.0, 0.0)), 1.5, createNormalMaterial(vec3(1.0), 0.01, 1.0));
    const int SPHERE_NUMS = 6;
    Sphere spheres[SPHERE_NUMS] = Sphere[SPHERE_NUMS](
        Sphere(vec3(-0.75, 0.25, -0.3), 0.25, createNormalMaterial(vec3(0.78, 0.38, 0.0), 0.5, 0.3)),
        Sphere(vec3(0.0, 0.25, -0.3), 0.25, createNormalMaterial(vec3(0.78, 0.58, 0.0), 0.3, 0.5)),
        Sphere(vec3(0.75, 0.25, -0.3), 0.25, createNormalMaterial(vec3(0.78, 0.78, 0.0), 0.01, 1.0)),
