...
val spherePlane = """
    ...
    Sphere spheres[SPHERE_NUMS] = Sphere[SPHERE_NUMS](
        Sphere(vec3(-0.75, 0.25, -0.5), 0.25, createNormalMaterial(vec3(0.78, 0.38, 0.0), 0.0, 0.3, 0.1)),
        Sphere(vec3(0.0, 0.25, -0.5), 0.25, createNormalMaterial(vec3(0.78, 0.58, 0.0), 0.0, 0.5, 0.1)),
        Sphere(vec3(0.75, 0.25, -0.5), 0.25, createNormalMaterial(vec3(0.78, 0.78, 0.0), 0.0, 1.0, 0.1)),
        
        Sphere(vec3(-0.75, 0.25, 1.0), 0.25, createNormalMaterial(vec3(0.8, 0.5, 0.5), 0.3, 0.0, 0.3)),
        Sphere(vec3(0.0, 0.25, 1.0), 0.25, createNormalMaterial(vec3(0.8, 0.7, 0.5), 0.5, 0.0, 0.7)),
